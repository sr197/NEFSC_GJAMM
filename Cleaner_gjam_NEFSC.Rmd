...
spec_coords_1 <- data.frame(name=rep(0,115), x=rep(0,115), y=rep(0,115))
...
spec_coords_2 <- data.frame(name=rep(0,115), x=rep(0,115), y=rep(0,115))
for (i in 1:length(specnames)) { #for each species in spec_list
...
write.csv(dist_total, "dist_total_full_115.csv")
