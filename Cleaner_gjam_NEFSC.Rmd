...
#okay this one works, but why doesn't it work when I do the hab vars???
...
xdata$SBF_GRP <- as.factor(as.character(xdata$SBF_GRP))
...
out <- gjam(~ avgdepth + bottemp + botsalin + AMO_unsm_year + NAO_year, xdata, ycommon, modelList = ml)
